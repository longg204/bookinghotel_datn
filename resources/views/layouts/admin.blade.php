            ...
            <div class="section-menu-left">
                <div class="box-logo">
                    <a href="{{ route('home.index') }}" id="site-logo-inner">
                        <img class="logo_image" id="logo_header_1" alt="" src="{{ asset('assets/images/logohotel.png') }}"
                             data-light="{{ asset('assets/images/logohotel.png') }}" data-dark="{{ asset('assets/images/logohotel.png') }}">
                    </a>
                            ...
                            <li class="menu-item has-children">
                                ...
                                <ul class="sub-menu">
                                    <li class="sub-menu-item">
                                        <a href="{{ route('admin.room.add') }}" class="">
                                            <div class="text">Add Room</div>
                                        </a>
                                    </li>
                                    <li class="sub-menu-item">
                                        <a href="{{ route('admin.room') }}" class="">
                                            <div class="text">Rooms</div>
                                        </a>
                                    </li>
                                </ul>
                ...
                <div class="header-dashboard">
                    <div class="wrap">
                        <div class="header-left">
                            <a href="index-2.html">
                                <img class="logo_image" id="logo_header_mobile" alt="" src="{{ asset('assets/images/logohotel.png') }}"
                                     data-light="{{ asset('assets/images/logohotel.png') }}" data-dark="{{ asset('assets/images/logohotel.png') }}"
                                     data-width="154px" data-height="52px" data-retina="{{ asset('assets/images/logohotel.png') }}">
                            </a>
                            <div class="button-show-hide">
                                <i class="icon-menu-left"></i>
                            </div>
                                    ...
                                    <ul class="">
                                        ...
                                        <li>
                                            <ul>
                                                ...
                                                <li class="product-item gap14 mb-10">
                                                    <div class="image no-bg">
                                                        <img src="{{ asset('images/products/21.png') }}images/products/21.png" alt="">
                                                    </div>
                                                    <div class="flex items-center justify-between gap20 flex-grow">
                                                        <div class="name">
                                    ...
                                    <button class="btn btn-secondary dropdown-toggle" type="button"
                                            ...
                                            <span class="header-user wg-user">
                                                ...
                                                <span class="flex flex-column">
                                                    @if(Auth::getUser())
                                                        <span class="body-title mb-2">{{ Auth::getUser()->name  }}</span>
                                                    @endif
