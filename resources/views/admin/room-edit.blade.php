                ...
                <div class="wg-box">
                    <fieldset class="name">
                        ...
                        <input class="mb-10" type="text" placeholder="Enter room name" name="name" tabindex="0"
                               value="{{ $room->name }}" aria-required="true" required="">
                    ...
                    <fieldset class="name">
                        ...
                        <input class="mb-10" type="text" placeholder="Enter room slug" name="slug" tabindex="0"
                               value="{{ $room->slug }}" aria-required="true" required="">
                        <div class="text-tiny">Do not exceed 100 characters when entering the room name.</div>
                    </fieldset>
                    @error('slug')
                    <span class="alert alert-danger text-center">{{ $message }}</span>
                    ...
                    <fieldset class="shortdescription">
                        ...
                        <textarea class="mb-10 ht-150" name="short_description" value="{{ $room->short_description }}"
                                  placeholder="Short Description" tabindex="0" aria-required="true"
                                  required="">{{ $room->short_description }}</textarea>
                        <div class="text-tiny">Do not exceed 100 characters when entering the room name.</div>
                    </fieldset>
                    ...
                    <fieldset class="description">
                        ...
                        <textarea class="mb-10" name="description" value="{{ $room->description }}"
                                  placeholder="Description" tabindex="0" aria-required="true" required="">{{ $room->description }}</textarea>
                        <div class="text-tiny">Do not exceed 100 characters when entering the room name.</div>
                    </fieldset>
                    @error('description')
                    <span class="alert alert-danger text-center">{{ $message }}</span>
                        ...
                        <div class="upload-image flex-grow">
                            @if($room->image)
                                <div class="item" id="imgpreview">
                                    <img src="{{ asset("uploads/room") }}/{{ $room->image }}" class="effect8" alt="Preview">
                                </div>
                            @endif
                        ...
                        @if($room->images)
                            @foreach(explode(",", $room->images) as $img)
                                    <div class="item gitems">
                                        <img src="{{ asset("uploads/room") }}/{{ trim($img) }}" alt="">
                                    </div>
                            @endforeach
                        @endif
                    ...
                    <div class="cols gap22">
                        <fieldset class="name">
                            ...
                            <input class="mb-10" type="text" placeholder="Enter regular price" name="regular_price"
                                   tabindex="0" value="{{ $room->regular_price }}" aria-required="true" required="">
                        </fieldset>
                        @error('regular_price')
                        <span class="alert alert-danger text-center">{{ $message }}</span>
                        @enderror
                        ...
                        <fieldset class="name">
                            ...
                            <input class="mb-10" type="text" placeholder="Enter sale price" name="sale_price"
                                   tabindex="0" value="{{ $room->sale_price }}" aria-required="true" required="">
                        </fieldset>
                        @error('sale_price')
                        <span class="alert alert-danger text-center">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="cols gap22">
                        <fieldset class="name">
                            ...
                            <input class="mb-10" type="text" placeholder="Enter quantity" name="quantity" tabindex="0"
                                   value="{{ $room->quantity }}" aria-required="true" required="">
                        </fieldset>
                        @error('quantity')
                        <span class="alert alert-danger text-center">{{ $message }}</span>
                        @enderror
                        ...
                        <fieldset class="name">
                            ...
                            <div class="select mb-10">
                                <select class="" name="stock_status">
                                    <option value="instock" {{ $room->stock_status == "instock" ? "selected" : "" }}>InStock</option>
                                    <option value="outofstock" {{ $room->stock_status == "outofstock" ? "selected" : "" }}>Out of Stock</option>
                                </select>
                            </div>
                        </fieldset>
                        @error('stock_status')
                        ...
                        <fieldset class="name">
                            ...
                            <div class="select mb-10">
                                <select class="" name="featured">
                                    <option value="0" {{ $room->featured == 0 ? "selected" : "" }}>No</option>
                                    <option value="1" {{ $room->featured == 1 ? "selected" : "" }}>Yes</option>
                                </select>
                            </div>
                        </fieldset>
                        @error('featured')
