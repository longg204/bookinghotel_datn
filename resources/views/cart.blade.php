                                    ...
                                    <tr>
                                        <td>
                                            <div class="shopping-cart__product-item">
                                                <img loading="lazy" src="{{ asset("uploads/room") }}/{{ $item->model->image }}" width="120" height="120" alt="{{ $item->name }}"/>
                                            </div>
                                        </td>
                                        <td>
                ...
                @else
                    <div class="row">
                        <div class="col-md-12 text-center pt-5 bp-5">
                            ...
                            <a href="{{ route("room.index") }}" class="btn btn-info">Room now</a>
                        </div>
                    </div>
                @endif
            </div>
