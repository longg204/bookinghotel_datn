...
@section('content')
    ...
    <main class="pt-90">
                    ...
                    <div class="product-single__media" data-media-type="vertical-thumbnail">
                            ...
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide product-single__image-item">
                                        <img loading="lazy" class="h-auto" src="{{ asset("uploads/room") }}/{{ $room->image }}" width="674" height="674" alt="{{ $room->name }}"/>
                                    ...
                                    @foreach(explode(",", $room->images) as $gimg)
                                        <div class="swiper-slide product-single__image-item">
                                            <img loading="lazy" class="h-auto" src="{{ asset("uploads/room") }}/{{ $gimg }}" width="674" height="674" alt="{{ $room->name }}"/>
                                            <a data-fancybox="gallery" href="../images/products/product_0.html" data-bs-toggle="tooltip" data-bs-placement="left" title="Zoom">
                                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <use href="#icon_zoom"/>
                                                </svg>
                        ...
                        <div class="product-single__thumbnail">
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide product-single__image-item">
                                        <img loading="lazy" class="h-auto" src="{{ asset("uploads/room") }}/{{ $room->image }}" width="104" height="104" alt="{{ $room->name }}"/>
                                    </div>
                                    @foreach(explode(",", $room->images) as $gimg)
                                        <div class="swiper-slide product-single__image-item">
                                            <img loading="lazy" class="h-auto" src="{{ asset("uploads/room") }}/{{ $gimg }}" width="104" height="104" alt="{{ $room->name }}"/>
                                        </div>
                                    @endforeach
                                </div>
                            </div>
                ...
                <div class="col-lg-5">
                    <div class="d-flex justify-content-between mb-4 pb-md-2">
                        <div class="breadcrumb mb-0 d-none d-md-block flex-grow-1">
                            ...
                            <a href="{{ route("room.index") }}" class="menu-link menu-link_us-s text-uppercase fw-medium">
                                The Room
                            </a>
                        </div><!-- /.breadcrumb -->
                    ...
                    <h1 class="product-single__name">{{ $room->name }}</h1>
                    ...
                    <div class="product-single__addtolinks">
                        ...
                        @else
                            <form id="wishlist-form" name="addtowishlist-form" method="post" action="{{ route("wishlist.add") }}">
                                @csrf
                                <input type="hidden" name="id" value="{{ $room->id }}"/>
            ...
            <div class="product-single__details-tab">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <a class="nav-link nav-link_underscore active" id="tab-description-tab" data-bs-toggle="tab" href="#tab-description" role="tab" aria-controls="tab-description" aria-selected="true">
                            Description
                        </a>
                    </li>
                    <li class="nav-item" role="presentation">
                        <a class="nav-link nav-link_underscore" id="tab-additional-info-tab" data-bs-toggle="tab" href="#tab-additional-info" role="tab" aria-controls="tab-additional-info" aria-selected="false">
                            Additional Information
                        </a>
                    </li>
                    <li class="nav-item" role="presentation">
                        <a class="nav-link nav-link_underscore" id="tab-reviews-tab" data-bs-toggle="tab" href="#tab-reviews" role="tab" aria-controls="tab-reviews" aria-selected="false">
                            Reviews (2)
                        </a>
                    </li>
                </ul>
        ...
        <section class="products-carousel container">
            <h2 class="h3 text-uppercase mb-4 pb-xl-2 mb-xl-4">Related
                <strong>Rooms</strong>
            </h2>
                        ...
                        @foreach($related_rooms as $related_room)
                            <div class="swiper-slide product-card">
                                <div class="pc__img-wrapper">
                                    <a href="{{ route("room.detail", $related_room->slug) }}">
                                        <img loading="lazy" src="{{ asset('uploads/room') }}/{{ $related_room->image }}" width="330" height="400" alt="Cropped Faux leather Jacket" class="pc__img">
                                        @foreach(explode(",", $related_room->images) as $rgimg)
                                            <img loading="lazy" src="{{ asset('uploads/room') }}/{{ $rgimg }}" width="330" height="400" alt="{{ $related_room->name }}" class="pc__img pc__img-second">
                                        @endforeach
                                    </a>
                                    @if(Cart::instance("cart")->content()->where("id", $room->id)->count() > 0)
                                        <a href="{{ route("cart.index") }}" class="pc__atc btn anim_appear-bottom btn position-absolute border-0 text-uppercase fw-medium js-add-cart js-open-aside btn-warning">
                                            Go to cart
                                        </a>
                                    @else
                                        <form name="addtocart-form" method="post" action="{{ route("cart.add") }}">
                                ...
                                <div class="pc__info position-relative">
                                    <p class="pc__category">{{ $related_room->category->name }}</p>
                                    <h6 class="pc__title">
                                        <a href="details.html">{{ $related_room->name }}</a>
                                    </h6>
                                    <div class="product-card__price d-flex">
                                        @if($related_room->sale_price)
                                            <span class="money price price-old">
                                                ${{ $related_room->regular_price }}</span>
                                            <span class="money price price-sale">
                                                ${{ $related_room->sale_price }}</span>
                                        @else
                                            <span class="money price price-sale">
                                                ${{ $related_room->regular_price }}</span>
                                        @endif
