...
{{--                                            <span class="text-right float-end">{{ $category->rooms->count() }}</span>--}}
                                        </li>
                                    @endforeach
                                </ul>
                            </div>
                ...
                <div class="accordion" id="price-filters">
                    <div class="accordion-item mb-4">
                        ...
                        <div id="accordion-filter-price" class="accordion-collapse collapse show border-0" aria-labelledby="accordion-heading-price" data-bs-parent="#price-filters">
                            <input class="price-range-slider" type="text" name="price_range" value="" data-slider-min="1" data-slider-max="999999" data-slider-step="5" data-slider-value="[{{ $min_price }},{{ $max_price }}]" data-currency="$"/>
                            <div class="price-range__info d-flex align-items-center mt-2">
                                ...
                                <div>
                                    ...
                                    <span class="price-range__max">$999999</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="shop-list flex-grow-1">
                                ...
                                <div class="slide-split_text position-relative d-flex align-items-center" style="background-color: #f5e6e0;">
                                    <div class="slideshow-text container p-3 p-xl-5">
                                        ...
                                        <p class="mb-0 animate animate_fade animate_btt animate_delay-5">Accessories are
                                            the best way to update your look. Add a title edge with new styles and new
                                            colors, or go for timeless pieces.</p>
                                    </div>
                                </div>
                                <div class="slide-split_media position-relative">
                                    <div class="slideshow-bg" style="background-color: #f5e6e0;">
                                        <img loading="lazy" src="assets/images/bannerroom2.jpg" width="630" height="450" alt="Women's accessories" class="slideshow-bg__img object-fit-cover"/>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="d-flex justify-content-between mb-4 pb-md-2">
                    ...
                    <div class="shop-acs d-flex align-items-center justify-content-between justify-content-md-end flex-grow-1">
                        <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0 mr-4" aria-label="Page size" id="pagesize" name="pagesize">
                            <option value="12" {{ $size == 12 ? "seleceted" : "" }}>Show</option>
                            <option value="24" {{ $size == 24 ? "seleceted" : "" }}>24</option>
                            <option value="48" {{ $size == 48 ? "seleceted" : "" }}>48</option>
                            <option value="102" {{ $size == 102 ? "seleceted" : "" }}>102</option>
                        </select>
...
{{--                                            {{dd($room)}}--}}
    ...
    <form id="frmfilter" method="GET" action="{{ route("room.index") }}">
        <input type="hidden" name="page" value="{{ $rooms->currentPage() }}">
